...
# Save scanline plots and data for level-wise scaling factors and final combined attenuation map for Pre-HPF + Fattal.
...
# Import Pre-HPF + Fattal modules and configs
...
def process_single_image(img_path, ds_dir, base_output_dir, param):
    ...
    # Define save directory structure (same as exe_scanline_multiple_param.py)
