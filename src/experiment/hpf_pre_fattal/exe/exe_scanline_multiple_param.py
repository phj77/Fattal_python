...
def main():
    utils.start_timer()
    utils.print_elapsed("Pre-HPF + Fattal 다중 파라미터 스캔라인 출력 작업 시작")
    ...
    for d_idx, ds_dir in enumerate(dataset_dirs, 1):
        ...
        print(f"총 {total_tasks}회의 Pre-HPF + Fattal 스캔라인 생성 작업 진행 예정")
        print("=" * 60)
    ...
    utils.print_elapsed("Pre-HPF + Fattal 스캔라인 출력 작업 완료")
