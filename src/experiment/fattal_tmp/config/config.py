...
OUTPUT_DIR = str(experiment_result_path/"fattal_tmp"/"first_data"/"2_2")
...
PARAM_GRID = {
    'opt_alpha': [0.9],
    'opt_beta': [0.78,0.8,0.81,0.82,0.83,0.84,0.85,0.86,0.87,0.88,0.89,0.9,0.91,0.92,0.93,0.94,0.95,0.96,0.97,0.98,0.99],
    'opt_noise': [0.001],
    'newfattal': [True],
    'fftsolver': [True],
    'detail_level': [0],
