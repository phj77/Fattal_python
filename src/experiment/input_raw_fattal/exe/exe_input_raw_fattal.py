...
from experiment.input_raw_fattal.fattal.fattal_tmo import pfstmo_fattal02
from experiment.input_raw_fattal.config.config import (
...
def main():
    utils.start_timer()
    utils.print_elapsed("RAW Input Fattal TMO 시작")
    ...
    utils.print_elapsed("RAW Input Fattal TMO 프로그램 전체 종료")
