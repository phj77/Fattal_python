...
project_root = current_file.parents[4] # src/experiment/scaling_factor_modified/config/config.py -> 4 levels up
data_path = project_root / "data" 
test_path = project_root / "test"

# 입출력 디렉토리 설정
INPUT_DIR = str(data_path / "data_one" / "3")
OUTPUT_DIR = str(test_path / "scaling_factor_modified"/"tmp"/"pre_hpf")
...
alpha_range_v2 = np.round(np.arange(0.2, 0.8, 0.2), 2).tolist()
