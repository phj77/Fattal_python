...
experiment_result_path = result_root / "experiment_result" / "input_raw_reverse"

# 입출력 디렉토리 설정
INPUT_DIR = str(data_path / "tmp_hard_case"/"20260706135050956_F220260706135052_3072x2048_NG"/"01_3072 x 2048_130kV_0.3mA_F_pos(1)_NG.raw")
OUTPUT_DIR = str(experiment_result_path /"tmp_hard_case"/"side_crop" /"20260706135050956_F220260706135052_3072x2048_NG")
# 입출력 디렉토리 설정
# INPUT_DIR = r"C:\Users\Park_HyoungJun\LAB\mission\poor_battery_enhancement\data\Full_dataset\260721_train_raw"
# OUTPUT_DIR = r"C:\Users\Park_HyoungJun\LAB\mission\poor_battery_enhancement\src\Fattal_python\experiment_result\input_raw_reverse\B1_B2_a0.8_b0.8"
